  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={{ padding: 10, borderTopColor: 'rgba(33, 150, 243, 0.8)', borderTopWidth: 1 }}>
        <TouchableOpacity onPress={toggleDayNight} style={{ paddingVertical: 20 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            {isSun ? (
              <Ionicons name="sunny-outline" size={22} style={{ color: 'rgba(33, 150, 243, 0.8)' }} />
            ) : (
              <Ionicons name="moon-outline" size={22} style={{ color: 'rgba(33, 150, 243, 0.8)' }} />
            )}
            <Text style={{ fontSize: 15, color: 'rgba(33, 150, 243, 0.8)' }}>{isSun ? 'Day' : 'Night'}</Text>
          </View>
        </TouchableOpacity>
        <View style={{ padding: 10, borderTopColor: 'rgba(33, 150, 243, 0.8)', borderTopWidth: 1 }}>
